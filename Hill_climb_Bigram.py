...
cipher_key = 'cmhlfsbrqvwdpynikxetoazjug'
#cipher_key =   'XZTJWUMOBEPARIQKDLFSCHYGNV' # Alphabets in english language
#text = input('Enter the string :')
print()        # Input message
text = "theencryytionissoimportantnowadaystosecurethedatatransferfromoneendtoanotherend"
print()
text_list = []
...
def hill_climb(key_1):
    ...
    for i in range(len(cipher_text_list)):       
        crypt = dictionary.get(cipher_text_list[i])
